...
ARG NODE_DOMAIN=node66.railway.internal
RUN mkdir -p /src/certs && \
    openssl req -x509 -newkey ec \
        ...
        -days 3650 -nodes \
        -subj "/CN=node66.railway.internal" \
        -addext "subjectAltName = DNS:node66.railway.internal,DNS:*.railway.internal,DNS:localhost,IP:127.0.0.1"
